  ...
  return (
    <>
      ...
      <main>
        ...
        <section id="donation">
          <h1 id="about-donation">100% of proceeds are donated</h1>
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                ...
                <li>Somalia</li>
                <li>South Georgia and the South</li>
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                ...
                starting at 8:00 AM(EST). During peak periods, processing times
                may exceed 2 business days.
              </p>
              <p>
            ...
            <li>
              ...
              <p>
                ...
                with thefigmastore@harperandscott.com.
              </p>
            </li>
            <li>
