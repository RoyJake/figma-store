...
import "./page.css";
import headerImages from "./lib/imageArray.ts";
import figma_collections from "./lib/figmaCoSvgs.ts";
import {
  figmaCollectionImages,
  productName_N_Price,
} from "./lib/figmaCoImages.ts";

import { useDispatch } from "react-redux";
// import { RootState} from './lib/redux/redux_store.ts'
import { productUpdate } from "./lib/redux/product.ts";

export default function Home() {
  // const productName = useSelector((state: RootState) => state.productName.productName);
      ...
      <NavBar />
        ...
        <section className="figmaCollection-section">
          <h1 id="figmaCollection-header">
            ...
            <Image
              className="fig-collectionsSvgs"
              src={figma_collections[1].src}
              width={28}
              height={28}
              alt="hourglass"
            />
            <span>of </span>
            <span className="layers-link">layers</span>
            <Image
              className="fig-collectionsSvgs"
              src={figma_collections[2].src}
              width={28}
              height={28}
              alt="zag"
            />
            ...
            <Image
              className="fig-collectionsSvgs"
              src={figma_collections[3].src}
              width={28}
              height={28}
              alt="dots"
            />
            <span className="components-link">components</span>
            <Image
              className="fig-collectionsSvgs"
              src={figma_collections[4].src}
              width={28}
              height={28}
              alt="sun"
            />
          ...
          <div className="grid">
            {figmaCollectionImages.map((image, index) => (
              <Link
                ...
                key={index}
                id={`box_${index}`}
                className={`grid_box ${productName_N_Price[index].route}`}
              ...
              >
                ...
                <div
                  className='grid_text_box'
                >
                  {productName_N_Price[index].noNew ? (
                    <p>
                      <span>{productName_N_Price[index].name}</span>
                    </p>
                  ) : (
                    <p>
                      <span className="newSpan">
                        {productName_N_Price[index].name.slice(0, 4)}
                      </span>
                      <span>{productName_N_Price[index].name.slice(5)}</span>
                    </p>
                  )}

                  <p className="priceText">{`$${productName_N_Price[index].price}`}</p>
                </div>
              </Link>
            ))}
          </div>
